...
#define MXWechatAPPID       @"wxd930ea5d5a258f4f"
// 开放平台登录https://open.weixin.qq.com的开发者中心获取AppSecret。
#define MXWechatAPPSecret   @"db426a9829e4b49a0dcac7b4162da6b6"
// 微信支付商户号
#define MXWechatMCHID       @"1900000109"
// 安全校验码（MD5）密钥，商户平台登录账户和密码登录http://pay.weixin.qq.com
// 平台设置的“API密钥”，为了安全，请设置为以数字和字母组成的32字符串。
#define MXWechatPartnerKey  @"8934e7d15453e97507ef794cf7b0519d"
