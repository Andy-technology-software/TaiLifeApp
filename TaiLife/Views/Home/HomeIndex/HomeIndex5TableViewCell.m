...
@interface HomeIndex5TableViewCell()
...
@end
@implementation HomeIndex5TableViewCell
...
- (void)makeUI{
    self.title0 = [XRQController createLabelWithFrame:self.contentView.frame Font:14 Text:@"泰华精选"];
...
- (void)clickBClick:(UIButton*)btn{
    [self.HomeIndex5TableViewCellDelegate sendBack5Item:btn.tag - 100];
    
}

- (void)moreBtnClick {
    [self.HomeIndex5TableViewCellDelegate s5MoreClick];
